...
public class UserMapReduce {
    ...
    static class RawDataReduce extends Reducer<Text,Text,NullWritable,Text>{
        ...
        */
        ...
        protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            for (Text value : values) {
                ...
                if (fields.length == 7) {
                    ...
                    */
                    ...
                    //u = new UserTotal(fields[1], "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", fields[3], fields[4], fields[5], "", "", "", "", "", "", "");
            ...
            String provinceId = resultArray[11];
            String cityId = resultArray[12];
            String countyId = resultArray[13];
            String streetId = resultArray[14];
            String provinceName = orgMap.get(provinceId);
            String cityName = orgMap.get(provinceId);
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        conf.set("platformPath", platformPath);
        conf.set("orgPath", orgPath);
        ...
        FileOutputFormat.setOutputPath(job,new Path("/Users/shawn/test/001"));
